...
//           console.log(
//             `Shard${t.id}: Ping to the server was ${pingResult ? 'successful' : 'unsuccessful'}.`,
//           );
//           if (!pingResult) {
//             t.init();
//           }
...
//       if (this.authorized) this.email = email;
//       else this.email = undefined;
...
//   useKey(key) {
//     return __awaiter(this, void 0, void 0, function* () {
//       const data = yield this.shard.sendRequest('keyAuth', { key });
...
//     return __awaiter(this, void 0, void 0, function* () {
//       if (!this.authorized) throw new Error('Action requires authorization.');
//       if (!this.name) this.name = yield this.shard.sendRequest('getName');
